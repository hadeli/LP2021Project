...
--
-- Table structure for table `Container2`
--
DROP TABLE IF EXISTS `Container2`;
...
INSERT INTO `CONTAINER_MODEL` VALUES (1,'P\'tit Container2',5000,3000,3000),(2,'Moyen Container2',10000,3000,3000),(3,'Fat Container2',20000,3000,3000);
...
CREATE TABLE `CONTAINER_PRODUCT` (
                                     ...
                                     CONSTRAINT `CONTAINER_PRODUCT_CONTAINER_ID_fk` FOREIGN KEY (`CONTAINER_ID`) REFERENCES `Container2` (`ID`),
