...
use App\Normalizer\CONTAINER_PRODUCTNormalizer;
use Exception;
...
class CONTAINER_PRODUCTController extends AbstractController
{
    /**
    ...
    public function createContrainerProduct(Request $req): Response
    {
        ...
        $remainingReq = $this->getDoctrine()->getRepository(CONTAINER_PRODUCT::class)->getRemainingSpace($req->request->get("CONTAINER_ID"));
        ...
        $norm = new CONTAINER_PRODUCTNormalizer();
        return $this->json([
            'status' => 'OK',
            'code' => 0,
    ...
    {
        return $this->json($this->getDoctrine()->getRepository(CONTAINER_PRODUCT::class)->find($id));
    }
}